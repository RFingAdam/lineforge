...
air.AddCylinder(
    [0, 0, L2_top - plane_t], [0, 0, L2_top + plane_t],
    antipad_d / 2, priority=20,
)

# Signal via barrel from L1 to L3 (short via)
pec.AddCylinder(
    [0, 0, L3_top - trace_t/2], [0, 0, L1_top + plane_t],
    drill_d / 2, priority=30,
)
...
pec.AddCylinder(
    [0, 0, L1_top - plane_t/2], [0, 0, L1_top + plane_t/2],
    pad_d / 2, priority=30,
)
...
# L3 via pad
pec.AddCylinder(
    [0, 0, L3_top - trace_t/2], [0, 0, L3_top + trace_t/2],
    pad_d / 2, priority=30,
)
