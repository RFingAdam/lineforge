...
@overload
def solve(
    geometry: EmbeddedMicrostrip, *, frequency_hz: float | None = ...
) -> TLineResult: ...
@overload
def solve(
    geometry: StriplineSymmetric, *, frequency_hz: float | None = ...
) -> TLineResult: ...
@overload
def solve(
    geometry: StriplineAsymmetric, *, frequency_hz: float | None = ...
) -> TLineResult: ...
@overload
