...
Run::
    ...
    atlc3 view --bmp my_usermap.bmp --pixel-width 0.1mm
...
from atlc3.visualization.fields import FieldKind, render_contour_lines, render_field
...
def run_viewer(bmp_path: Path, *, pixel_width: str) -> None:
    ...
    while True:
        ...
        if cmd in {"U", "V", "E", "D", "T"}:
            ...
            out = Path("atlc3_view_lines_v.png")
            img.save(out)
            last_image_path = out
