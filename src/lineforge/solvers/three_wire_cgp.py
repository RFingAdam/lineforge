...
from lineforge.analytical._constants import EPS0, MU0
from lineforge.analytical.three_wire import y_decomposition
from lineforge.geometry.usermap import Usermap
from lineforge.results import SolverWarning, ThreeWireResult
from lineforge.solvers import laplace
from lineforge.solvers.cgp import _energy_integral, _extract_masks
...
def solve_modes(
    ...
    *,
    ...
    via :func:`lineforge.analytical.three_wire.y_decomposition` to give
