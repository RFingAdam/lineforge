...
Routes a geometry through:
    ...
    - rasterization → Laplace bitmap solve via :func:`lineforge.solvers.solve_cgp`.
...
from lineforge.geometry.types import GeometryUnion
...
def solve(
    ...
    *,
    ...
    ----------
    geometry
        A model from :mod:`lineforge.geometry.types` or a :class:`Usermap`.
    method
