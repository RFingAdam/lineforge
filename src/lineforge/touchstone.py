...
Example
-------
>>> from lineforge import microstrip_geom  # doctest: +SKIP
...
def to_touchstone(
    ...
    *,
    ...
    ----------
    sweep_results
        Output of :func:`lineforge.sweep.sweep` with ``parameter="frequency"``.
    ...
    net = skrf.Network(
        frequency=freq, s=s_matrix, z0=z_ref, name=f"lineforge-line-{length_m * 1e3:.3f}mm"
    )
