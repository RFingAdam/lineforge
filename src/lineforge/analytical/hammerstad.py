...
from lineforge.analytical._constants import C0, ETA0, INCH_M
from lineforge.geometry.types import EmbeddedMicrostrip, Microstrip
from lineforge.results import SolverWarning, TLineResult
...
def microstrip(
    ...
    *,
    ...
    ----------
    geometry
        :class:`~lineforge.geometry.types.Microstrip` instance (all dims in meters).
    frequency_hz
