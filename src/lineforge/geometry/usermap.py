...
from lineforge.materials import ATLC2_DEFAULTS, MaterialRecord, build_lookup
...
class Usermap:
    ...
    def from_json(cls, path: str | Path) -> Usermap:
        """Load a usermap from the lineforge-native JSON format."""
