...
from lineforge.materials import MaterialRecord, build_lookup
...
def _dielectric_rgb_for_er(er: float, tan_delta: float) -> tuple[int, int, int]:
    ...
    """
    from lineforge.materials.database import ATLC2_DEFAULTS
    ...
    *,
    ...
    return Usermap(
        ...
        UsermapMetadata(
            ...
            source="lineforge.geometry.builders.rasterize_microstrip",
        ),
    )
    ...
    *,
    ...
    return Usermap(
        ...
        UsermapMetadata(
            ...
            source="lineforge.geometry.builders.rasterize_embedded_microstrip",
        ),
    )
    ...
    *,
    ...
    return Usermap(
        ...
        UsermapMetadata(
            ...
            source="lineforge.geometry.builders.rasterize_stripline_symmetric",
        ),
    )
    ...
    *,
    ...
    return Usermap(
        ...
        UsermapMetadata(
            ...
            source="lineforge.geometry.builders.rasterize_stripline_asymmetric",
        ),
    ...
    *,
    ...
    return Usermap(
        ...
        UsermapMetadata(
            pixel_width_m=px,
            name="cpwg",
            source="lineforge.geometry.builders.rasterize_cpwg",
        ),
    )
    ...
    *,
    ...
    return Usermap(
        ...
        UsermapMetadata(
            ...
            source="lineforge.geometry.builders.rasterize_edge_coupled_diff_microstrip",
        ),
    )
    ...
    *,
    ...
    return Usermap(
        ...
        UsermapMetadata(
            ...
            source="lineforge.geometry.builders.rasterize_edge_coupled_diff_stripline",
        ),
    )
    ...
    *,
    ...
    return Usermap(
        ...
        UsermapMetadata(
            ...
            source="lineforge.geometry.builders.rasterize_broadside_coupled_diff_stripline",
        ),
    )
...
def rasterize(
    ...
    *,
    ...
    ----------
    geometry
        Any model from :mod:`lineforge.geometry.types`.
    pixel_width
